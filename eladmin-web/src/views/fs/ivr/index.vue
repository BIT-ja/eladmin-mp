<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <!--表单组件-->
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title + crud.add" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          <el-form-item label="被叫小号" prop="destNum">
            <el-input ref="destNumInput" v-model="form.destNum" style="width: 370px;" />
          </el-form-item>
